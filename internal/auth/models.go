...
const (
	...
	PermCampaignsGetIndivCpgLinkClicks      = "campaigns:get_indiv_cpg_link_clicks"
	PermCampaignsGetIndivCpgLinkClicksUsers = "campaigns:get_indiv_cpg_link_clicks_users"
